    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 leading-6">
            ...
            <div className="col-span-1 space-y-4">
                {[1, 2].map((index) => (
                    <div key={index} className="group">
                        ...
                        <div className="p-4">
                            <h2 className="text-lg font-bold group-hover:underline"><a href={news[index]?.link} target="_blank" rel="noopener noreferrer">{news[index]?.title}</a></h2>
            ...
            <div className="group col-span-1 md:col-span-2 lg:col-span-2 relative">
                ...
                <div className="p-4">
                    <h2 className="text-xl font-bold group-hover:underline"><a href={news[0]?.link} target="_blank" rel="noopener noreferrer">{news[0]?.title}</a></h2>
            ...
            <div className="col-span-1 md:col-span-4 lg:col-span-1 space-y-4">
                {[3, 4, 5, 6].map((index) => (
                    <div key={index} className="group">
                        <div className="p-4">
                            <h2 className="text-lg font-bold group-hover:underline"><a href={news[index]?.link} target="_blank" rel="noopener noreferrer">{news[index]?.title}</a></h2>
